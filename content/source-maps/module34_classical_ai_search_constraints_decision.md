...
| S34-08 | von Neumann and Morgenstern, [Theory of Games and Economic Behavior material](https://assets.press.princeton.edu/about_pup/PUP100/book/2cNeumann.pdf) | C08; conditional expected-utility representation under named preference and lottery assumptions. | Accessed 2026-07-31. Publisher-hosted material; cite/link and use original finite examples only. |
...
| S34-11 | NIST, [AI Risk Management Framework 1.0](https://doi.org/10.6028/NIST.AI.100-1) | C09; oversight, context, harms, accountability, and risk controls as design/review concerns. | Accessed 2026-07-31. Official guidance; link-only/original paraphrase; not legal advice or authorization. |
