...
All entries below were accessed on 2026-07-31. “Link-only/original
paraphrase” is the current Atlas decision even where the underlying project is
open source: it avoids silently carrying source, documentation, figure, sample,
or attribution obligations into a future course asset.
