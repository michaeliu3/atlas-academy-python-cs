...
| Session 5: randomness/approximation | Probability contract, reproducibility boundary, lower/upper certificate, and 1/2 proof boundary | `U04`, `U05`, `P01` | A seed is not a distribution proof, and an example/benchmark grants no approximation ratio. |
...
(`U05`); or documented Python mechanism (`P01`). These links are not an answer
key, a reading pile, or authority to bypass M10 or M12.
