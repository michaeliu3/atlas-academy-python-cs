...
**2026-08-01**; S36-18–S36-20 were checked on **2026-08-02**. “Link/cite only” means the source may guide a future author
...
| S36-20 | MIT OpenCourseWare, [6.7960 Deep Learning, Lecture 17: Out-of-Distribution Generalization](https://ocw.mit.edu/courses/6-7960-deep-learning-fall-2024/mit6_7960_f24_lec17.pdf) | Official lecture route that juxtaposes adversarial examples with broader distribution shifts. Supports M36-S05's distinction between a declared synthetic perturbation set/budget/label-preservation assumption and a named shift relation; it does not validate Atlas's two-bit card or prove robustness. | MIT OCW material is **link-only/original-paraphrase** pending exact asset review. Do not copy slides, figures, examples, attacks, or empirical claims; retain only Atlas's original synthetic card and non-claims. |
