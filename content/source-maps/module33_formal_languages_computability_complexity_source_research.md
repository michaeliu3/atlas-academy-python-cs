...
| S33-12 | Stanford, [CS103 Mathematical Foundations of Computing (Spring 2026) course archive](https://web.stanford.edu/class/archive/cs/cs103/cs103.1266/) | Stanford course staff; official university-hosted current-quarter route | Current-quarter proof-first calibration for regular expressions, NFA, DFA, subset construction, CFG, stack-based PDA, regular pumping, polynomial verifier, and diagonal-language assumptions. The previously checked theorem-reference archive is a historical provenance anchor only, not a current-quarter claim source. | Course archive is linked for study. No blanket Atlas reuse permission is recorded; **link-only/original paraphrase** and independently authored examples only. |
...
| S33-14 | MIT OpenCourseWare, [18.404J F2020 Lecture 6: TM Variants, Church–Turing Thesis](https://ocw.mit.edu/courses/18-404j-theory-of-computation-fall-2020/7405f6112c8ca7242e1edd9a021c1e63_MIT18_404f20_lec6.pdf) and Stanford [CS103 Spring 2026 course archive](https://web.stanford.edu/class/archive/cs/cs103/cs103.1266/) | MIT and Stanford course staff; official university-hosted course material | Uses the current-quarter Stanford route for calibration and the MIT lecture for an original Session 3 configuration-boundary explanation: a bounded simulation observes halting only if a halting configuration occurs among \(c_0,\ldots,c_k\), without becoming a total halting decider. Any older Stanford reference anchor is historical provenance only, not a current-quarter claim source. | Accessed 2026-08-03; current-quarter route rechecked 2026-08-04. Link-only/original paraphrase; do not copy source prose, figures, pseudocode, or exercises. |
...
3. **Release binding remains unbuilt.** A private M33 workbook now provides
   six draft sessions, diagnostics, retrieval, a dossier rubric, and TA/Study
   Partner oral material. Its local bounded DFA trace fixture/test makes one
   declared finite-machine exercise inspectable, but it is not a recognizer or
   proof system for arbitrary claims. A canonical learner-route/review binding
   and release evidence remain absent; this research note does not create them.
