...
| S05 | [MIT 6.441: Information Theory](https://ocw.mit.edu/courses/6-441-information-theory-spring-2016/) and [lecture-note index](https://ocw.mit.edu/courses/6-441-information-theory-spring-2016/pages/lecture-notes/) | Entropy, conditional entropy, divergence, mutual information, data-processing, maximum-entropy, coding interpretations, variational characterizations, and rate-distortion viewpoints. | Link/cite and author original explanations/visuals/code; asset notices govern any reuse. |
...
| C09 | Newton, quasi-Newton, subgradient, proximal, coordinate, momentum, and adaptive updates are different algorithms with different information and geometry contracts. | Exact update/state rule, smooth versus nonsmooth objective split, Hessian or subgradient oracle, coordinate/state schedule, regularization/prox definition, step/decay/bias-correction policy, and numerical representation. | A method name, secant relation, finite trace, or faster-looking run does not establish global optimality, a portable convergence rate, or validity of the objective. |
...
| C10 | Data-processing, maximum-entropy, and coding statements are conditional interpretations of information quantities, not free-standing quality scores. | A named Markov chain and joint law for data-processing; support, normalization, and constraints for maximum entropy; source law, code class, block regime, and loss for coding. | A finite MI estimate can rise by noise; an unconstrained “maximum entropy” choice is incomplete; a compression ratio or tokenizer score is not a coding theorem. |
...
| M31-S04 — Projected updates, method families, and bounded convergence evidence | Turn a declared constrained problem into iterative evidence. Read projected-gradient, Newton/quasi-Newton, subgradient/proximal, coordinate, momentum, and adaptive updates as different contracts, then keep an exact-gradient rate card beside the finite trace. | Inspect the bounded projected-gradient trace and classify a method-state pseudocode fragment; inspect SciPy/CVXPY contract boundaries without treating them as theorem certificates. | Predict which oracle/state or stopping quantity changes; retrieve the theorem-versus-run distinction; transfer by naming why the rate card cannot be inherited by a projected, nonsmooth, coordinate, momentum, or stochastic trace. Produce the solver-selection rationale. | S02–S04, S09–S11; M28/M29 bridge |
...
| M31-S06 — Information trade-offs and evidence defense | Reunite the probability model, optimization target, approximation family, finite computation, and decision boundary through entropy, KL, MI, data-processing, maximum-entropy, coding, ELBO, and distortion/fit trade-offs. | Derive a small finite categorical KL identity with support labels; inspect a Markov compression, constrained maximum-entropy, or prefix-code claim; audit an original variational or regularized objective. | Predict what changing KL direction, a Markov bottleneck, a constraint, code regime, or trade-off weight changes; retrieve support/log-base/family conditions; transfer by explaining what an improved objective or compression score still cannot establish. Produce the Optimization & Information Evidence Dossier and learner-controlled oral summary. | S05–S06; M30 bridge |
