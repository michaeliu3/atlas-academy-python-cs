...
| S22-05 | [NIST SP 800-63-4, final](https://csrc.nist.gov/pubs/sp/800/63/4/final) | Define authentication as a claimant demonstrating control of authenticators; distinguish it from authorization. Scope to the NIST digital-identity model, not a generic application-login recipe. |
| R22-01 | [RFC 8446 status](https://www.rfc-editor.org/info/rfc8446/), [RFC 9846, TLS 1.3](https://www.rfc-editor.org/rfc/rfc9846.html), and [BCP 195 / RFC 9325 status](https://www.rfc-editor.org/info/rfc9325/) | RFC 8446 is obsolete and RFC 9846 is the current TLS 1.3 specification. RFC 9325 remains baseline TLS/DTLS guidance with later updates named by its status record. Link learners to the current status/successor pages; do not teach a custom TLS protocol or reduce certificate verification to a checkbox. |
