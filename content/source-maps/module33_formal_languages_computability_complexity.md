...
| S33-12 | Stanford, [CS103 Mathematical Foundations of Computing (Spring 2026) course archive](https://web.stanford.edu/class/archive/cs/cs103/cs103.1266/) | Sessions 1–3; current-quarter proof-first calibration for formal objects, subset construction, stack-based PDA, pumping, verifier, and diagonal encoding. The previously checked CS103 theorem-reference archive is a historical provenance anchor only, not a current-quarter claim source. | Accessed 2026-08-02; current-quarter route rechecked 2026-08-04. No blanket reuse permission. Link-only/original paraphrase and examples. |
...
| S33-14 | MIT OpenCourseWare, [18.404J F2020 Lecture 6: TM Variants, Church–Turing Thesis](https://ocw.mit.edu/courses/18-404j-theory-of-computation-fall-2020/7405f6112c8ca7242e1edd9a021c1e63_MIT18_404f20_lec6.pdf) and Stanford [CS103 Spring 2026 course archive](https://web.stanford.edu/class/archive/cs/cs103/cs103.1266/) | M33-C05–C06, Session 3; uses the current-quarter Stanford route for calibration and the MIT lecture for the original configuration-boundary explanation: a bounded simulation reports a halt only when a halting configuration is observed among \(c_0,\ldots,c_k\), and it remains distinct from a decider. Any older Stanford reference anchor is historical provenance only, not a current-quarter claim source. | Accessed 2026-08-03; current-quarter route rechecked 2026-08-04. Link-only/original paraphrase; do not copy source prose, figures, pseudocode, or exercises. |
