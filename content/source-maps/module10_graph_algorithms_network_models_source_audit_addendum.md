...
undergraduate models and proof traditions; Python documentation bounds public
...
selection (`U03`); all-pairs reweighting connection (`U06`); MST reasoning (`U05`); documented deque behavior (`P01`);
...
graph question, preserve its information, assign a frontier/edge schedule,
state an invariant, produce a witness, and qualify cost. It joins formal graph
