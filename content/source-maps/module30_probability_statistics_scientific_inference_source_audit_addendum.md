...
| **S05** | Penn State, [STAT 415 Introduction to Mathematical Statistics course description](https://bulletins.psu.edu/university-course-descriptions/undergraduate/stat/) | The current catalog confirms the theoretical scope—sufficiency, estimation, testing, regression, analysis of variance, and chi-square tests. MIT and NIST provide the detailed learner-facing route for likelihood, power, and resampling. | The catalog is link-only evidence of course scope; do not infer a complete lecture sequence or reuse Penn State assets. |
