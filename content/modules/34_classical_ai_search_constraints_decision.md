...
| M34-S06 | `M34-C01–M34-C12 -> S34-01–S34-22` | Revisit the applicable session route, then use the [full M34 primary-source research ledger](../source-maps/module34_classical_ai_search_constraints_decision.md) to check its narrower use and reuse boundary. |
