...
| M31–M36 advanced extension | Six private authoring workbooks exist under `content/authoring/`, each with connected sessions, sources, diagnostics, project/dossier, oral-defense, TA/Study Partner, and forward-handoff material. M33–M36 include source-calibrated formal, AI, ML, and learning-theory reasoning traces; focused M31/M33/M36 proof audits corrected two condition/scope gaps. The [study-ready gap audit](research/m31-m36-study-ready-gap-audit.md) records the remaining source/accessibility/release and operational-delivery boundaries. | Private instructor-led study drafts only; authoring-only/hidden in the portal and not learner-ready portal modules. A real learner-approved chat pilot and focused candidate review are required before a module-specific release decision. |
