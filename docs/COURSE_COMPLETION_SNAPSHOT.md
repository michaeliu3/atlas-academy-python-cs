...
2. Before any portal M31–M36 publication decision, perform a focused
   ...
   checklist.
3. Deliberately retain the private guided route or promote selected material to
   a learner-visible portal stage; either decision must preserve honest graph,
   source, accessibility, and release language.
