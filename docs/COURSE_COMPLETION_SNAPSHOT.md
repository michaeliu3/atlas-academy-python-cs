...
| Academic calibration | [Academic calibration index](ACADEMIC_CALIBRATION.md), range notes, targeted M1–M36 official-source reviews, and a representative material-level review sample cover M1–M36. | Scope calibration is complete for this pass; material-level review is in progress and supports targeted improvement, not institutional equivalence. Revisit when a genuine content gap is found. |
