...
| --- | --- | --- |
| [M1–M5 foundations review](research/academic-calibration-m1-m5-source-review.md) and [official learner-route recheck](research/m1-m5-official-source-review-2026-08-01.md) | State, recursion/induction, ADTs, proof, and cost models against official MIT and CMU anchors. | **Aligned/adapted.** Keep the proof-to-cost bridge; concise learner-facing source cards now record what is calibrated and what practice scale remains deferred. |
...
| [M17–M20 architecture-to-protocol review](research/academic-calibration-m17-m20-source-review.md) | Execution, OS mediation, concurrency, and application protocols against official MIT, CMU, Stanford, Georgia Tech, and Berkeley anchors. | Preserve the connected systems chain and its explicit boundaries; no core authoring change is justified. |
...
| [M33–M34 focused candidate review](research/m33-m34-focused-candidate-review.md) | Formal-language limits and classical AI search/decision against MIT, Stanford, CMU, Georgia Tech, and Berkeley anchors. | Make the diagonal encoding explicit and distinguish search completeness from optimality; preserve authoring-only status. |
