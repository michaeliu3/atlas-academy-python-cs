...
| [M6–M10 data-structures review](research/academic-calibration-m6-m10-source-review.md), [official learner-route recheck](research/m6-m10-official-source-review-2026-08-01.md), and [M10 network-flow follow-up](research/m10-network-flow-follow-up-2026-08-04.md) | Representation, restricted interfaces, hashing, ordered structures, graph algorithms, and a bounded network-flow bridge against official MIT, CMU, Stanford, Georgia Tech, and Berkeley anchors. | **Aligned/adapted.** The M10 follow-up adds first-principles capacity/conservation, residual reversibility, max-flow/min-cut proof, code-reading, and cut-certificate work; defer broader tree families, production routing, and institutional-scale implementation volume. |
| [M11–M16 algorithms-and-durable-systems review](research/academic-calibration-m11-m16-source-review.md) and the [archived calibration-rerun index](archive/calibration-reruns/README.md) | Algorithm design, interfaces, specifications, change, delivery, and transactions against official MIT, CMU, Stanford, Georgia Tech, and Berkeley anchors. | Preserve the M11 scope handoff and reuse one visible evidence thread across M12–M15; M11 now states the ideal probability model before its reservoir-sampling induction and carries a compact M6→M10 five-handoff architecture-reading dossier. |
...
| [M31–M36 authoring-only review](research/academic-calibration-m31-m36-source-review.md), followed by the current [M31–M32](research/m31-m32-official-calibration-2026-08-03.md), [M33–M34](research/m33-m34-official-calibration-2026-08-03.md), and [M35–M36](research/m35-m36-official-calibration-2026-08-03.md); superseded reruns are retained in the [calibration-rerun archive](archive/calibration-reruns/README.md) | Optimization through reliable-learning systems against official MIT, CMU, Stanford, Georgia Tech, Berkeley, and relevant platform owners. | Keep every pack hidden/authoring-only in the portal. The current pass found no additional theory expansion worth adding; it refreshed M33's Stanford CS103 link, bounded M34's goal-test claim, and made M35's sampling-unit/stable-loss reasoning explicit while preserving the remaining portal learner-delivery, rendered-review, and release evidence gaps. |
