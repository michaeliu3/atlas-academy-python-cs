...
Private instruction may begin directly from a named workbook and companion.
A first designated-chat session can provide optional operational-observation
evidence; it is not a readiness gate. A focused candidate review remains
