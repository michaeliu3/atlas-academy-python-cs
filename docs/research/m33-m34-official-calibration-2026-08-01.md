...
| M33 | [Stanford CS103, Spring 2026](https://web.stanford.edu/class/archive/cs/cs103/cs103.1266/) | A proof-first route from discrete mathematics to computability and complexity is a suitable standard for Atlas’s definition, counterexample, and oral-explanation emphasis. |
