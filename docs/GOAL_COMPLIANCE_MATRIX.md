...
| Local progress privacy, rendering safety, and headers | In progress | Shared versioned codec, forged-record regressions, conservative response-header tests | Sanitize Markdown/SVG/Mermaid; add malicious-content regressions and verify production headers. |
