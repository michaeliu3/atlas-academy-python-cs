...
- [x] M30 — probability, statistics, and scientific inference, with a
...
1. `v0.1-foundations` — Modules 0–5, diagnostic, foundation evidence.
2. `v0.2-algorithms` — Modules 6–11, data/algorithm studios.
