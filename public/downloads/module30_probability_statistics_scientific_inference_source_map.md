...
| S05 | [Penn State STAT 415 course description](https://bulletins.psu.edu/university-course-descriptions/undergraduate/stat/) | Current catalog-level calibration for the theoretical mathematical-statistics scope: sufficiency, estimation, testing, regression, analysis of variance, and chi-square tests. MIT and NIST sources supply the detailed learner-facing route for likelihood, power, and resampling. | The catalog is link-only evidence of course scope; do not infer a complete lecture sequence or reuse Penn State assets. |
...
3. **Inference depth:** MIT 18.650 and the Penn State STAT 415 catalog
