...
export function DiscreteMathProofStudio() {
    ...
    const hydrationTimer = window.setTimeout(() => {
      try {
        ...
        const restored = storage
          ? restoreModule27Progress(storage)
          : null;
  ...
  useEffect(() => {
    ...
    if (!storage) return;
    try {
      persistModule27Progress(storage, record);
    } catch {
  ...
  function clearSavedPredictionEvidence() {
    const storage = getBrowserProgressStorage();
    const cleared = storage ? clearModule27Progress(storage) : false;
    ...
    <section className={styles.studio} aria-labelledby="discrete-proof-studio-title">
      ...
      <div className={styles.footerBand}>
        ...
        <div className={styles.footerLinks}>
          ...
          <button
            aria-describedby="module27-clear-progress-description"
            className={styles.revealButton}
          ...
          <p id="module27-clear-progress-description">
            This clears only saved choices, confidence, and revealed arguments
            from this browser.
          </p>
